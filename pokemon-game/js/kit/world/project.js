...
(function (root) {
  ...
  KIT.registry('strings').addAll([
    ...
    { id: 'start-own', default: 'Start your own game' },
    { id: 'start-own-title', default: 'What is it called?' },
    { id: 'start-own-hint', default: 'Pick what you start with. Every part of it can be changed afterwards.' },
    { id: 'start-own-made', default: '“{title}” is yours. Paint something.' },
    { id: 'start-own-replaces', default: 'This replaces “{was}”.' },
    { id: 'start-own-undo', default: 'One undo step: ↶ in Creator Mode brings “{was}” back.' },
    { id: 'start-own-go', default: 'Start “{title}”' },
    { id: 'start-own-keep', default: 'Keep what I have' },
